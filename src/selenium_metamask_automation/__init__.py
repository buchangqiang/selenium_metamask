...
EXTENSION_PATH = os.path.abspath(r"..") + '\extension\extension_metamask.crx'
...
def launchSeleniumWebdriver(driverPath):
    ...
    # options.add_extension('C:\work_code\selenium_metamask\extension_metamask.crx')    
    options.add_argument('--load-extension='+EXTENSION_DIR_PATH)
...
def metamaskSetup(recoveryPhrase, password,index=0):
    driver.switch_to.window(driver.window_handles[index])
    print('start metamaskSetup...')
